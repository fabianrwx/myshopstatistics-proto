...
type CreateUserRequest struct {
	...
	Role   string `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"` // Other fields as needed
}
...
func (x *CreateUserRequest) GetShopId() string {
	if x != nil {
		return x.ShopId
	}
	return ""
...
type User struct {
	...
	Role   string `protobuf:"bytes,5,opt,name=role,proto3" json:"role,omitempty"` // Other fields as needed
}
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x6a, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x2d, 0x0a,
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x6d, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x32, 0x67, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65,
